 ...
 */
@Controller
public class ValidateInProDeleteAction extends ActionSupport implements SessionAware, ServletResponseAware, ServletRequestAware{
...
//        Integer proAmount = Integer.parseInt(amount);
        ...
        if(instoreDetail == null){//原来detail上没有的product，不用验证直接删
            result = "success";
        }else {
            //获得当前入库单年月 供库存信息表查询用
