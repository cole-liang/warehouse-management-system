 ...
 */
@Controller
public class CheckInByDeptAction extends ActionSupport implements SessionAware, ServletResponseAware, ServletRequestAware{
    ...
    public String execute(){
        List<InstoreSheetEntity> list = instoreService.findInstoreSheetByDept(department);
