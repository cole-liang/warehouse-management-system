 ...
 */
@Controller
public class CheckInByIdAction extends ActionSupport implements SessionAware, ServletResponseAware, ServletRequestAware{
    ...
    public String execute(){
        List<InstoreSheetEntity> list = new ArrayList<InstoreSheetEntity>();
        list.add(instoreService.findInstoreSheetById(Integer.parseInt(instoreSheetId)));
