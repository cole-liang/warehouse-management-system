 ...
 */
@Controller
public class CheckOutByDeptAction extends ActionSupport implements SessionAware, ServletResponseAware, ServletRequestAware{
    ...
    public String execute(){
        List<OutstoreSheetEntity> list = outstoreService.findOutstoreSheetByDept(department);
