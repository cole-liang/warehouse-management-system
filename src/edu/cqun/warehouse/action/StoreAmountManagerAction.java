...
@Controller
public class StoreAmountManagerAction extends ActionSupport implements SessionAware, ServletResponseAware, ServletRequestAware{
    ...
    public String execute(){
        List<StoreAmountEntity> list = storeAmountService.findAllStoreAmount();
