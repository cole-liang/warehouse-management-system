...
<head>
  ...
  <script src="../js/checkOutById.js"></script>
</head>
<body>
<div id="container">
  <input type="hidden" id="username" value=${username}>
  <h2> 根据ID查询出库单 </h2>
  <span>请输入要查询的出库单ID：</span><input type="text" id="outstoreSheetId"><input type="button" value="查询" id="check">
  <table>
    <tr id="tableTitle">
      <th>编号</th>
      <th>出库时间</th>
