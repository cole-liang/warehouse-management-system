...
<head>
  ...
  <script src="../js/modifyForInstorev03.js"></script>
</head>
<body>
<div id="container">
  <input type="hidden" id="username" value=${username}>
  <input type="hidden" id="instoreSheetId" value=${instoreSheetId}>
  <input type="hidden" id="userLevel" value=${level}>
  <div id="inner">
    <div id="header">
      <h2>修改入库信息</h2>
      <div id="basicInfo">
        <span>当前入库单编号：${instoreSheetId}</span>
  ...
  <div id="outer2">
    <div class="inputInfo">
      ...
      <p class="validateProId"> </p>
      <p class="addInfo"><span>添加数量：</span><input type="text" id="productAmount2" class="validateProAmount"/><span class="tip">（*必填）</span></p>
      <p class="validateAmount"> </p>
